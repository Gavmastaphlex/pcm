        ...
        <div class="flexslider">
          <ul class="slides">
            ...
            <li>
              ...
              <map name="taibi_map">
                <area shape="rectangle" coords="0,10,310,300" alt="" class="fancybox" href="#video-area2">
              </map> 
                <div id="video-area2">
                  ...
                  <video width="620" height="240" controls id="video-player2">
                    <source src="videos/taibi.mp4" type="video/mp4">
                    <source src="videos/taibi.ogg" type="video/ogg">
                    <source src="videos/taibi.webm" type="video/webm">
